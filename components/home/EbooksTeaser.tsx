import { getFeaturedEbooks } from '@/lib/ebooks/queries'
import { EbookCard } from '@/components/features/EbookCard'

export async function EbooksTeaser() {
  const ebooks = await getFeaturedEbooks(3)
        ...
        {ebooks.length === 0 ? (
          ...
          <>
            ...
            <div style={{ textAlign: 'center', marginTop: 'var(--s10)' }}>
              <a href="/ebooks" className="btn btn-primary">
